...
const AuthBottomNavigation = () => {
    ...
    function HomeTabItem(props) {
        return (
            <Pressable onPress={changeModalState} style={[styles.tabItem, { backgroundColor: currentThemePrimaryColor }]}>
                <Foundation name="home" size={20} color={props.focused ? colors.appPrimary : colors.grey} />
                <Text style={commonStyles.textWhite(11, { color: props.focused ? colors.appPrimary : colors.grey, fontWeight: 'bold' })}>
                    Home
                </Text>
            </Pressable>
        );
    ...
    function SearchTab(props) {
        return (
            <Pressable onPress={changeModalState} style={[styles.tabItem, { backgroundColor: currentThemePrimaryColor }]}>
                <Ionicons name="search" size={20} color={props.focused ? colors.appPrimary : colors.grey} />
                <Text style={commonStyles.textWhite(11, { color: props.focused ? colors.appPrimary : colors.grey, fontWeight: 'bold' })}>
                    Search
                </Text>
            </Pressable>
    ...
    function MainTab(props) {
        return (
            <Pressable style={{ flex: 1, justifyContent: 'flex-end' }} onPress={changeModalState}>
                <View style={{
                    position: 'absolute',
                    bottom: 30,
                    alignSelf: 'center',
    ...
    return (
        ...
        >
            <WithoutLoginBottomNavigation.Screen name={navigationStrings.HomeScreen} component={HomeWithoutLogin} />
            <WithoutLoginBottomNavigation.Screen name={navigationStrings.SearchScreen} component={HomeWithoutLogin} />
            <WithoutLoginBottomNavigation.Screen name={navigationStrings.AddPost} component={HomeWithoutLogin} />
            <WithoutLoginBottomNavigation.Screen name={navigationStrings.Notifications} component={HomeWithoutLogin} />
            <WithoutLoginBottomNavigation.Screen name={navigationStrings.ProfileScreen} component={HomeWithoutLogin} />
        </WithoutLoginBottomNavigation.Navigator>
    )
}
...
export const AuthorizationStack = () => {
    ...
    return <AuthStack.Navigator screenOptions={navigationOptions} initialRouteName={navigationStrings.SplashScreen}>
        <AuthStack.Screen name={navigationStrings.ViewRestaurant} component={ViewRestaurant} />
        <AuthStack.Screen name={navigationStrings.SplashScreen} component={SplashScreen} />
        <AuthStack.Screen name={navigationStrings.LandingScreen} component={LandingScreen} />
        <AuthStack.Screen name={navigationStrings.AuthBottomNavigation} component={AuthBottomNavigation} />
        <AuthStack.Screen name={navigationStrings.Login} component={Login} />
        <AuthStack.Screen name={navigationStrings.Registration} component={Registration} />
        <AuthStack.Screen name={navigationStrings.ForgotPassword} component={ForgotPassword} />
        <AuthStack.Screen name={navigationStrings.TermsAndConditionsScreen} component={TermsAndConditions} />
    </AuthStack.Navigator>
}
