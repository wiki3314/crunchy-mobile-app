...
const BottomNavigation = () => {
  ...
  return (
    <AppBottomNavigator.Navigator
      ...
      initialRouteName={
        isNewUser ? navigationStrings.HomeScreen : navigationStrings.HomeScreen
      }
    >
        ...
        style={[
          {
            ...
            borderColor: props.focused ? colors.green : colors.transparent,
            borderWidth: 2,
            alignItems: "center",
...
export const MainNavigationStack = (props) => {
  ...
  return (
    <MainStackNavigator.Navigator
      ...
      initialRouteName={
        isNewUser
          ? navigationStrings.NewUserLandingPage
          : navigationStrings.BottomTabNavigation
      }
    >
      ...
      />
      <MainStackNavigator.Screen
        name={navigationStrings.NewUserLandingPage}
        component={NewUserLandingPage}
      />
      <MainStackNavigator.Screen
        name={navigationStrings.UserPreferences1}
        component={UserPreferences1}
      />
      <MainStackNavigator.Screen
        name={navigationStrings.BottomTabNavigation}
        component={BottomNavigation}
      />
      <MainStackNavigator.Screen
        name={navigationStrings.EditPost}
        component={EditPost}
      />
      <MainStackNavigator.Screen
      ...
      />
      <MainStackNavigator.Screen
        name={navigationStrings.RestaurantDetails}
        component={RestaurantDetails}
      />
      <MainStackNavigator.Screen
        name={navigationStrings.ShowUser}
        component={ShowUser}
      />
      <MainStackNavigator.Screen
        name={navigationStrings.UpdateSettings}
