...
const CircularProgress = ({
    ...
    if (progress > 50) {
        ...
        firstProgressLayerStyle = rotateByStyle(progress, rotation, clockwise);
    ...
    return (
        <View style={[styles.container, { width: radius * 2, height: radius * 2 }]}>
            ...
            <Text
                style={commonStyles.textWhite(42, { color: colors.appPrimary, fontWeight: 'bold', position: 'absolute' })}>
                {progress}%
            </Text>
        </View>
    );
...
CircularProgress.defaultProps = {
    ...
    bgRingWidth: 12,
    progressRingWidth: 6,
    ringColor: colors.appPrimary,
    ringBgColor: colors.grey,
    textFontSize: 40,
    textFontColor: 'black',
    textFontWeight: 'bold',
    clockwise: true,
